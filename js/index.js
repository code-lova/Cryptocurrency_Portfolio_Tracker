import { addCrypto, updateTotalValue } from "./portfolioManager.mjs";
import { fetchCryptoList } from "./apiService.mjs";
  ...
  document
    ...
    .addEventListener("submit", async (event) => {
      ...
      if (selectedCrypto) {
        ...
        await addCrypto(selectedCrypto.name, cryptoQuantity, selectedCrypto.image);
