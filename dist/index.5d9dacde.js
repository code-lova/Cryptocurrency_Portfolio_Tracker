...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    document.getElementById("crypto-form").addEventListener("submit", async (event)=>{
        ...
        if (selectedCrypto) {
            // Call addCrypto function to add details
            await (0, _portfolioManagerMjs.addCrypto)(selectedCrypto.name, cryptoQuantity, selectedCrypto.image);
    ...
    cryptoInput.addEventListener("input", async (event)=>{
        ...
        if (query.length === 0) {
            ...
            const cryptoList = await (0, _apiServiceMjs.fetchCryptoList)(query);
...
var _apiServiceMjs = require("./apiService.mjs");
var _chartsMjs = require("./charts.mjs");
var _uiComponentsMjs = require("./uiComponents.mjs");
async function addCrypto(name, quantity, image) {
    ...
    try {
        ...
        const historicalData = await (0, _apiServiceMjs.fetchHistoricalData)(name.toLowerCase(), 30);
        ...
        if (existingCrypto) {
            ...
            if (existingCrypto.quantity !== quantity) {
                ...
                const currentPrice = await (0, _apiServiceMjs.fetchCryptoPrice)(name.toLowerCase());
                if (!currentPrice) {
        ...
        (0, _chartsMjs.drawPriceChart)(historicalData);
    } catch (error) {
...
async function getTotalValue() {
    ...
    for (const crypto of portfolio)if (crypto.price) totalValue += crypto.quantity * crypto.price;
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getPortfolio", ()=>getPortfolio);
// Utility function to save portfolio to localStorage
parcelHelpers.export(exports, "savePortfolio", ()=>savePortfolio);
...
},{}],"6rMlk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchCryptoPrice", ()=>fetchCryptoPrice);
parcelHelpers.export(exports, "fetchHistoricalData", ()=>fetchHistoricalData);
// Fetch a list of cryptocurrencies based on user input (search)
parcelHelpers.export(exports, "fetchCryptoList", ()=>fetchCryptoList);
...
async function fetchHistoricalData(cryptoName, days = 30) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7G3wL":[function(require,module,exports) {
// charts.mjs
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "drawPriceChart", ()=>drawPriceChart);
...
function drawPriceChart(prices) {
    ...
    // Create a new chart instance and assign it to chartInstance
    chartInstance = new (0, _autoDefault.default)(ctx, {
        type: "line",
        data: {
            labels,
            datasets: [
...
function renderPortfolio() {
    ...
    if (portfolio.length > 0) (0, _chartsMjs.drawPriceChart)(portfolio[0].historicalData);
    ...
    portfolio.forEach((crypto)=>{
      ...
      `;
        ...
        cryptoItem.addEventListener("click", ()=>{
            (0, _chartsMjs.drawPriceChart)(crypto.historicalData);
        });
    });
